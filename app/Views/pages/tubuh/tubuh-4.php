            ...
            <div class="col-4 mx-3">
                <div class="card">
                    <div class="card-header">
                        <h4 class="fw-bold text-center pt-2 red_color">ANGGOTA TUBUH MANUSIA</h4>
                    </div>
                    <div class="card-body py-1">
                        <a href="/tubuh-4" class="btn btn-rounded my-3 mx-2 text-white btn_gray fs-5 fw-bold" role="button">
                            1</a>
                        <a href="/tubuh-2" class="btn btn-rounded my-3 mx-2 text-white btn_gray fs-5 fw-bold" role="button">
                            2</a>
                        <a href="/tubuh-3" class="btn btn-rounded my-3 mx-2 text-white btn_gray fs-5 fw-bold" role="button">
                            3</a>
                ...
                <div class="card">
                    <div class="card-body text-center pt-4 pb-0">
                        <div id="materi_cuaca">
                            ...
                            <h2 class="fw-bold text-uppercase red_color spacing mb-3" id="datatubuh"></h2>
                            <!-- <p>(<span class="text-capitalize text-center py-0" id="jenis"></span>)</p> -->

                            <?php
                            foreach ($data as $tubuh) {
                            ?>
                                <script>
                                    var data = [];
                                </script>
                                ...
                                for ($i = 15; $i < count($data); $i++) {
                                    $nama = $data[$i]['nama'];
                                    $gambar = "assets/img/data/tubuh/" . $data[$i]['gambar'];
                                ?>
                                    <script>
                                        data.push({
