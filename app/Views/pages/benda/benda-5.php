            ...
            <div class="col-4 mx-3">
                <div class="card">
                    <div class="card-header">
                        <h4 class="fw-bold text-center pt-2 red_color">BENDA</h4>
                    </div>
                    <div class="card-body py-1">
                        <a href="/benda-1" class="btn btn-rounded my-3 mx-2 text-white btn_gray fs-5 fw-bold" role="button">
                            1</a>
                        <a href="/benda-2" class="btn btn-rounded my-3 mx-2 text-white btn_gray fs-5 fw-bold" role="button">
                            2</a>
                        <a href="/benda-3" class="btn btn-rounded my-3 mx-2 text-white btn_gray fs-5 fw-bold" role="button">
                            3</a>
                        <a href="/benda-4" class="btn btn-rounded my-3 mx-2 text-white btn_gray fs-5 fw-bold" role="button">
                            4</a>
                ...
                <div class="card">
                    <div class="card-body text-center pt-4 pb-0">
                        <div id="materi_cuaca">
                            ...
                            <h2 class="fw-bold text-uppercase red_color spacing mb-0" id="namaBenda"></h2>
                            <p>(<span class="text-capitalize text-center py-0" id="jenis"></span>)</p>

                            <?php
                            foreach ($data as $benda) {
                            ?>
                                <script>
                                    var data = [];
                                </script>
                                ...
                                for ($i = 20; $i < count($data); $i++) {
                                    $jenis = $data[$i]['jenis'];
                                    $nama = $data[$i]['nama'];
                                    $gambar = "assets/img/data/benda/" . $data[$i]['gambar'];
                                ?>
                                    <script>
                                        data.push({
                ...
                <div class="row text-center">
                    <div class="col">
                        <div class="col card mt-2 px-2 bg_cream">
                            <p class="fw-bold text-white py-0 mb-0">Ayo sebutkan nama benda diatas!</p>
